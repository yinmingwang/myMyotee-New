...
public class MoreFragment extends LazyFragment {
    ...
    private int[] womanhair = new int[] {
            R.drawable.hair_0,R.drawable.pic_s1_g_1,R.drawable.pic_s1_g_2,R.drawable.pic_s1_g_3,R.drawable.pic_s1_g_4,
            R.drawable.pic_s1_g_5,R.drawable.pic_s1_g_6,R.drawable.pic_s1_g_7,R.drawable.pic_s1_g_8, R.drawable.pic_s1_g_9,
            ...
            R.drawable.pic_s1_g_27,R.drawable.pic_s1_g_28,R.drawable.pic_s1_g_29,R.drawable.pic_s1_g_30,R.drawable.pic_s1_g_31,
            R.drawable.pic_s1_g_32,R.drawable.pic_s1_g_33,R.drawable.pic_s1_g_34,R.drawable.pic_s1_g_35,R.drawable.pic_s1_g_36,
            R.drawable.pic_s1_g_37,R.drawable.pic_s1_g_38,R.drawable.pic_s1_g_39,R.drawable.pic_s1_g_40,R.drawable.pic_s1_g_41,
            R.drawable.pic_s1_g_42,R.drawable.pic_s1_g_43,R.drawable.pic_s1_g_44,R.drawable.pic_s1_g_45,R.drawable.pic_s1_g_46,
            R.drawable.pic_s1_g_47,R.drawable.pic_s1_g_49,R.drawable.pic_s1_g_50
    };
    ...
    private int[] eyebrow = new int[] {
            R.drawable.pic_s3_1,R.drawable.pic_s3_2,R.drawable.pic_s3_3,R.drawable.pic_s3_4,R.drawable.pic_s3_5,R.drawable.pic_s3_6,
            R.drawable.pic_s3_7,R.drawable.pic_s3_8,R.drawable.pic_s3_9,R.drawable.pic_s3_10,R.drawable.pic_s3_11,R.drawable.pic_s3_12,
            R.drawable.pic_s3_13,R.drawable.pic_s3_14,R.drawable.pic_s3_15,R.drawable.pic_s3_16,R.drawable.pic_s3_17,R.drawable.pic_s3_18,
            R.drawable.pic_s3_19,R.drawable.pic_s3_20,R.drawable.pic_s3_21,R.drawable.pic_s3_22,R.drawable.pic_s3_23,R.drawable.pic_s3_24,
            R.drawable.pic_s3_25,R.drawable.pic_s3_26,R.drawable.pic_s3_27,R.drawable.pic_s3_28,R.drawable.pic_s3_29,R.drawable.pic_s3_30,
            R.drawable.pic_s3_31
    };
    private int[] glass = new int[] {
            R.drawable.empty,
            R.drawable.pic_s7_1, R.drawable.pic_s7_2, R.drawable.pic_s7_3, R.drawable.pic_s7_4, R.drawable.pic_s7_5, R.drawable.pic_s7_6,
            R.drawable.pic_s7_7, R.drawable.pic_s7_8, R.drawable.pic_s7_9, R.drawable.pic_s7_10, R.drawable.pic_s7_11, R.drawable.pic_s7_12,
            R.drawable.pic_s7_13, R.drawable.pic_s7_14, R.drawable.pic_s7_15, R.drawable.pic_s7_16, R.drawable.pic_s7_17, R.drawable.pic_s7_18,
    ...
    protected void onCreateViewLazy(Bundle savedInstanceState) {
        ...
        List<Map<String, Object>> eyebrowlistItems = new ArrayList<Map<String, Object>>();
        for (int i = 0; i < eyebrow.length; i++) {
            Map<String, Object> eyebrowlistItem = new HashMap<String, Object>();
            eyebrowlistItem.put("eyebrow",eyebrow[i]);
            eyebrowlistItems.add(eyebrowlistItem);
        }
        List<Map<String, Object>> glasslistItems = new ArrayList<Map<String, Object>>();
        for (int i = 0; i < glass.length; i++) {
            Map<String, Object> glasslistItem = new HashMap<String, Object>();
            glasslistItem.put("glass",glass[i]);
            glasslistItems.add(glasslistItem);
        }
        //judge the type
        ...
        if (mantype == true) {
            ...
            if (tabIndex == 5) {
                SimpleAdapter eyebrowAdapter = new SimpleAdapter(MoreFragment.this.getContext(),eyebrowlistItems,R.layout.cell_select,
                        new String[] {"eyebrow"}, new int[] {R.id.cell_selectimageview1});
                gridView.setAdapter(eyebrowAdapter);
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ((ManActivity)getActivity()).changeImage("eyebrow",position);
                    }
                });
            }
            if (tabIndex == 6) {
                SimpleAdapter glassAdapter = new SimpleAdapter(MoreFragment.this.getContext(),glasslistItems,R.layout.cell_select,
                        new String[] {"glass"}, new int[] {R.id.cell_selectimageview1});
                gridView.setAdapter(glassAdapter);
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        if (position < 11 || position == 20) {
                            ((ManActivity)getActivity()).changeImage("glass",position);
                        } else if (position == 19) {
                            ((ManActivity)getActivity()).changeImage("glass",11);
                        } else {
                            ((ManActivity)getActivity()).changeImage("glass",position+1);
                        }
        ...
        if (mantype == false) {
            if (tabIndex == 0) {
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        int temp = position+76;
                        ((ManActivity)getActivity()).changeImage("hair",temp);
